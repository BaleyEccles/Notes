...
\label{sec:org17c682d}
\subsection{b}
\label{sec:orge83be4d}
\begin{minted}[]{octave}
clear
clc
close
...
imwrite(uint16(output), 'ENG204-Assignment-3-b-1.png');
\end{minted}
\subsection{c}
\label{sec:org25aa0b7}
\begin{minted}[]{octave}
clear
clc
close
